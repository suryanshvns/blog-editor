...
function addResolversToSchema(schema, resolvers) {
    ...
    for (const [typeName, fieldConfigs] of Object.entries(resolvers)) {
        ...
        if ((0, graphql_1.isAbstractType)(type)) {
            const existingExtensions = type.extensions;
                ...
                if (fieldName === '__resolveReference') {
                    type.extensions = {
                        ...
                        apollo: {
                            ...
                            subgraph: {
                                ...(_a = existingExtensions.apollo) === null || _a === void 0 ? void 0 : _a.subgraph,
            ...
            if (fieldName === '__resolveReference') {
                type.extensions = {
                    ...
                    apollo: {
                        ...existingExtensions.apollo,
                        subgraph: {
                            ...(_b = existingExtensions.apollo) === null || _b === void 0 ? void 0 : _b.subgraph,
                            resolveReference: fieldConfig,
                        },
                    },
                };
